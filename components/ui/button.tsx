...
const buttonVariants = cva(
  "inline-flex justify-center items-center gap-2.5 font-medium text-base leading-6 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer corner-squircle",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default: "h-12 px-4 py-2 rounded-full",
        sm: "h-10 px-3 py-2 rounded-full",
        lg: "h-14 px-6 py-3 rounded-full",
      },
    },
    defaultVariants: {
      variant: "default",
